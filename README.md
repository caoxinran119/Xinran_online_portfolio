...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* --- 优化后的: Main Background Image Container (实现淡入淡出转场) --- */
        .main-bg-image {
            position: fixed;
            top: 0;
            left: 0;
            ...
            z-index: 0; 
            /* 调整 1/3：非 Home 页面的默认/基础透明度提升到 0.25 */
            opacity: 0.25; 
            /* 调整 2/3：降低默认滤镜强度，使图片更容易被看到 */
            filter: grayscale(50%) brightness(0.7); 
            /* 关键：只对 opacity 和 filter 进行过渡，时间设置为 0.5s */
        ...
        .home-bg-filter {
            /* 提高透明度，使图片更可见 */
            opacity: 0.8 !important; /* Home 页面使用更高的透明度 */
            /* 降低灰度和亮度，使图片颜色和细节更清晰 */
...
<body class="is-loading">
    ...
    <nav>
        <div class="logo">Cao Xinran">Cao Xinran</div>
        <div class="nav-links">
    ...
    <script>
        ...
        const bgDiv = document.getElementById('main-background'); // 获取新增的背景图元素
        let currentPage = 'home';

        // =======================================================
        // ========== 1. 背景图路径配置 (Page Backgrounds) ==========
        // =======================================================
        
        // 替换以下路径为您放在 caoxinranphoto/ 文件夹中的实际背景图文件名
        const backgroundImages = {
            // 🚨 路径已修正 (Base URL 会处理开头的斜杠)
            'home': [
                'https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/FLAG_exh7.jpg',    
                'https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/FF_3.jpg',    
                'https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/MN_stand_by_the_river.png',    
                'https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/NEO_3.jpg',    
                'https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/MN_riverside.png'     
            ],
            // 其他页面的单张背景图
            'works': 'https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/back.png',    
            'feed': 'caoxinranphoto/bg-feed.jpg',    
            'writing': 'https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/backforwriting.jpg', 
            'store': 'caoxinranphoto/bg-store.jpg',    
            'about': 'https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/Xinran_portrait.jpg',    
        };

        // =======================================================
        // ========== 2. 作品数据及图片路径 (Project Data) ==========
        // =======================================================
        ...
        const projectsData = [
            { 
                ...
                description: "This work traces my return to the vacant lot where my elementary school once stood, rebuilding its vanished architecture through an AR excavator that digs up structures no longer there. 我的小学已经变成废墟。在它曾经所在的空地上,一台挖掘机正在挖掘已经消失的建筑。", 
                type: "Video / AR Installation", 
                year: "2025",
                // Works 索引页的预览图 (鼠标悬停时右侧显示)
                previewImagePath: "https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/FF_2.jpg", 
                // 作品详情页的配图
                detailVisuals: [
                    { label: "Still 1: Dust Motes", path: "https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/FF_3.jpg" }, 
                    { label: "Still 1: Dust Motes", path: "https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/FF_2.jpg" }, 
                    { label: "Still 2: Empty Hallway", path: "https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/FF_4.jpg" } 
                ],
                // 作品详情页的背景图
                backgroundImage: 'https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/FF_1.png', 
            ...
            { 
                ...
                year: "2024",
                previewImagePath: "https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/NEO_1.png", 
                detailVisuals: [
                    { label: "Photo 1: Backs to each other", path: "https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/NEO_2.png" }, 
                    { label: "Photo 1: Backs to each other", path: "https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/NEO_9.jpg" }, 
                    { label: "Photo 1: Backs to each other", path: "https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/NEO_5.jpg" }, 
                    { label: "Photo 2: Distance and Shadow", path: "https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/NEO_4.jpg" } 
                ],
                backgroundImage: 'https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/NEO_7.png', 
            ...
            { 
                ...
                year: "2023-Ongoing",
                previewImagePath: "https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/FLAG_exh3.jpg", 
                detailVisuals: [
                    { label: "Object View: Resin Cast", path: "https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/FLAG_walking.jpg" }, 
                    { label: "Text Detail: Embedded Fragment", path: "https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/FLAG_whisle.png" } 
                ],
                backgroundImage: 'https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/FLAG_explosion.png', 
                videoLink: "https://youtu.be/F03LG0NyYLU?si=e4i-BwYNkWulletd"
            },
            { 
                id: "project-04", 
                title: "River·Train·Flame", 
                caption: "River·Train·Flame",
                ...
                type: "Video", 
                year: "2024",
                previewImagePath: "https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/MN_train_river_.png", 
                detailVisuals: [
                    { label: "Screen Capture: Digital Etching", path: "https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/MN_kurtcobain_empty.png" }, 
                    { label: "Screen Capture: Digital Etching", path: "https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/MN_Dionysus.png" }, 
                    { label: "Screen Capture: Digital Etching", path: "https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/MN_stand_by_the_river.png" }, 
                    { label: "Text Fragment: Overheard Line", path: "https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/MN_windowview.png" } 
                ],
                backgroundImage: 'https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/MN_railway.png', 
            ...
            { 
                ...
                year: "2025",
                previewImagePath: "https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/The Lung of Algorithms_preview.png", 
                detailVisuals: [
                    { label: "Diagram: System Architecture", path: "https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/The Lung of Algorithms_total.png" }, 
                    { label: "Still: Mechanical Element", path: "https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/The Lung of Algorithms_black.png" }
                ],
                backgroundImage: 'https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/The Lung of Algorithms_Xray.jpg' 
            },
            { 
                id: "project-06", 
                ...
                year: "2023",
                previewImagePath: "https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/EMSOUND_2.png", 
                detailVisuals: [
                    { label: "Print Detail A", path: "https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/EMSOUND_1.png" }
                ],
                backgroundImage: 'https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/EMSOUND_1.png',
                videoLink: "https://youtu.be/AYm8pYy8168?si=9PiO8BwgpkENOyUY"
            },
            { 
                id: "project-07", 
                title: "Untitled", 
                caption: "Pure color field video loop.", 
                ...
                year: "2027",
                previewImagePath: "https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/placeholder-untitled.jpg", 
                detailVisuals: [
                    { label: "Still: Transition", path: "https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/placeholder-untitled-a.jpg" }, 
                    { label: "Setup: Projection Environment", path: "https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/placeholder-untitled-b.jpg" }
                ],
                backgroundImage: 'https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/placeholder-bg-untitled.jpg' 
            }
        ];
...
The painting wrinkled and softened in the flames, it melted little by little, turning to ashes along with their shadows. New Year's music sounded on the city radio, and cheerful accordions played a dance song.
...
The flames burned more and more, and their figures twisted and rose in the flames, as if他们 were freeGenie of the night. In dance, everything lost will be found, and all chases will find the answer.
`
                    }
                ]
            },
        ...
        function cycleHomeBackground() {
            ...
            homeBackgroundCycleInterval = setInterval(() => {
                ...
                // 1. 快速淡出当前图片 (利用 CSS transition: opacity 1.5s ease)
                bgDiv.style.opacity = 0; 
                
                // 2. 在淡出过程中（1.5s 后）更换图片 URL
                setTimeout(() => {
                    // Preload next image (optional but recommended)
                    const tempImg = new Image();
                    tempImg.onload = () => {
                        bgDiv.style.backgroundImage = `url('${nextImagePath}')`;
                        // 3. 淡入新图片 (恢复 Home 页面的高透明度)
                        bgDiv.style.opacity = 0.4; // 对应 .home-bg-filter 的 opacity 值
                    };
                    tempImg.src = nextImagePath;

                }, 1500); // 必须大于或等于 CSS transition 的时间 (1.5s)
                
            }, 6000); // 6秒切换一次 (1.5s 淡出 + 1.5s 淡入 + 3s 显示)
        }
        
        // Render Functions (保持不变)
        ...
        function renderProjectDetails(projectId) {
            ...
            // --- 视频链接逻辑 ---
            // 使用 project.videoLink 字段，如果存在则渲染按钮
        ...
        function renderFeed() {
            ...
            const posts = [
                // 路径已修正 (Base URL 会处理开头的斜杠)
                { date: "Dec 01, 2025", time: "14:30", type: "Image/Text", content: "The paramecium number on the road lives my fake Big Bang of the universe.", imagePath: "https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/boom.png" }, 
                ...
                { date: "Nov 15, 2025", time: "18:45", type: "Video Still", content: "The World to Me.", imagePath: "https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/theworldtome_2.jpeg" },
                { date: "Oct 22, 2025", time: "12:00", type: "Object", content: "The shape of ash...the relic of a city.", imagePath: "https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/ICEGROUP_2.png" },
            ];
            ...
            return `
                <section id="feed">
                    <div class="section-header">
                        ...
                        <p class="en-text" style="font-size: 1rem; color: var(--text-color); margin-bottom:0;">Current observations and fragmented thoughts.</p>
                    </div>
        ...
        function renderStore() {
            ...
            const products = [
                { 
                    ...
                    imagePath: "https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/STORE_earings.jpg" // 示例路径
                },
                { 
                    name: "ICE CUBE", 
                    price: "8 RMB", 
                    caption: "Small ice cubes tring to keep the shape of ash.",
                    imagePath: "https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/STORE_ICE_3.jpg" // 示例路径
                },
                { 
                    name: "Stillness Object (Hand-cast Resin)", 
                    price: "5 RMB", 
                    caption: "Use resin to preserve pigments or other small items as archives.",
                    imagePath: "https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/STORE_BG_ICEGROUP_1.png" // 示例路径
                },
            ];
                    ...
                    <div class="about-inner reveal">
                        <div class="about-content">
                            <div class="artist-portrait">
                                <img src="https://github.com/caoxinran119/Xinran_online_portfolio/blob/main/https://media.githubusercontent.com/media/caoxinran119/Xinran_online_portfolio/main/images/portrait_xinran_orange.jpg" alt="Cao Xinran Portrait" style="object-fit: cover; width: 100%; height: 100%; display: block;">
                            </div>
                            ...
                            <div class="statement-text">
                                ...
                                <pre class="p-serif">曹欣然以影像、文字与行为表演为主要媒介，持续关注日常生活与个人记忆的再遇与再思。
创作中，她常停留于一种“自由漂浮的思绪”状态，在想象、记忆与感知的交错中进行探索。
对她而言，“观察”既是一种方法，也是一种媒介——一种沉浸式地进入世界、感受其纹理，并从寻常事物之下挖掘隐秘叙事的方式。
尝试捕捉过去模糊的碎片与当下被忽略的微小瞬间。</pre>
        ...
        function navigate(path, skipHistory = false) {
            ...
            // 调整 3/3：Works 和 Writing 页面使用更亮的背景设置
            let targetOpacity = 0.3; // Writing 页的背景透明度
            let targetFilter = 'grayscale(60%) brightness(0.85)'; // Writing 页的背景滤镜更柔和

            if (pageKey === 'home') {
                targetOpacity = 0.4;
                targetFilter = 'grayscale(30%) brightness(0.5)';
                // 启动 Home 幻灯片循环 (它自己会设置背景图和滤镜类)
            }
            else if (pageKey === 'works' || isProjectRoute) {
                // Works 索引页和详情页
                targetOpacity = 0.25; // Works 页的背景透明度
                targetFilter = 'grayscale(80%) brightness(0.8)'; // Works 页的背景滤镜
                if (subKey) {
                ...
                if (isFragmentSectionRoute) {
                    ...
                    targetBgPath = backgroundImages['writing']; // ** 保持背景不变 **
                ...
                // 处理 feed, store, about 页面
                targetOpacity = 0.25; // 默认值
                targetFilter = 'grayscale(70%) brightness(0.7)'; // 默认值
            ...
            // --- 核心优化：背景图平滑过渡逻辑 ---
            // 只有当目标背景图路径与当前背景图路径不同时，才执行淡出/更换/淡入操作
            // 否则，只确保应用了正确的滤镜/透明度（用于同一页面内子路由切换）
            
            const currentBgUrl = bgDiv.style.backgroundImage.slice(5, -2); // Extracts URL without 'url("")'
            
            if (pageKey === 'home') {
                // Home 页面有专门的循环逻辑，这里只确保启动它
                ...
                setTimeout(() => {
                    ...
                    // 3. 淡入新背景
                    bgDiv.style.opacity = targetOpacity;
                }, 500); // 使用 CSS 定义的 0.5s 过渡时间

            } else if (bgDiv && targetBgPath) {
                // 如果背景路径相同 (例如，在 'writing' 的子路由之间切换)，确保样式应用但无淡入淡出延迟
                bgDiv.style.backgroundImage = `url('${targetBgPath}')`;
                bgDiv.style.filter = targetFilter;
                bgDiv.style.opacity = targetOpacity;
            }
